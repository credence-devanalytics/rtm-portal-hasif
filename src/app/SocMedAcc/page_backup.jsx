      ...
      if (value) {
        filtered = filtered.filter((item) => {
          ...
          if (key === 'unit' && value === 'official') {
            return item.unit === "Official" || item.isInfluencer === true || item.followerCount > 50000;
          }
          if (key === 'unit' && value === 'tv') {
            return item.unit === "TV" || item.unit?.toLowerCase().includes("tv") || item.platform === "YouTube";
          }
          if (key === 'unit' && value === 'berita') {
            return item.unit === "News" || item.unit?.toLowerCase().includes("news") || item.unit?.toLowerCase().includes("berita");
          }
          if (key === 'unit' && value === 'radio') {
            return item.unit === "Radio" || item.unit?.toLowerCase().includes("radio");
          }
