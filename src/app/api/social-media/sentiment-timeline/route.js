  ...
  try {
    ...
    try {
      ...
      const dailySentimentData = await db
        ...
        .groupBy(sql`DATE(${mentionsClassifyPublic.inserttime})`, mentionsClassifyPublic.autosentiment)
      ...
      dailySentimentData.forEach(item => {
        ...
        dateMap[date].totalInteractions += parseInt(item.totalInteractions) || 0;
      ...
      console.log('📊 Timeline data processed:', timelineData.length, 'data points');
