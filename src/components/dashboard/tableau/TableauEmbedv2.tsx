  ...
  return (
    <>
      ...
      <script type="text/javascript">
        ...
        'http://100.83.250.224:8080/javascripts/api/viz_v1.js';
...
const TableauEmbedv2: React.FC<TableauProps> = ({ url, sheetName }) => {
  const vizRef = useRef<HTMLDivElement>(null);
            ...
            (function() {
              ...
              if (divElement) {
                ...
                if (vizElement) {
                  ...
                  apiScript.src = 'http://100.83.250.224:8080/javascripts/api/viz_v1.js';
    ...
    <div style={{ width: "100%", height: "100%" }}>
      ...
      >
        ...
        <object className="tableauViz" style={{ width: "100%", height: "100%", display: "block" }}>
          <param name="host_url" value="http%3A%2F%2F100.83.250.224%3A8080%2F" />
          <param name="embed_code_version" value="3" />
          <param name="site_root" value="" />
